...
public class DateUtil {
	 ...
	 * 日期的格式
	 */
	final static public String DATE_FORMAT_COMMA = "yyyy.MM.dd";
	 ...
	 * 24小时, 日期+时间的格式
	 */
	final static public String DATE_MIN_FORMAT_COMMA = "yyyy.MM.dd HH:mm";
	...
	public static final SimpleDateFormat yyyMMddHHmm = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	 ...
	 * @return
	 */
	public static Date getNowTime(int beformDays) {
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.DAY_OF_YEAR, beformDays);
	...
	public static Date getTodayStart() {
		return DateUtil.parse(DateUtil.formatDateTime(new Date(), DateUtil.DATE_FORMAT) + " 00:00:00",
				DateUtil.DATE_TIME_FORMAT);
	}

	public static Date getTodayStart(String hhmmss) {
		return DateUtil.parse(DateUtil.formatDateTime(new Date(), DateUtil.DATE_FORMAT) + " " + hhmmss,
				DateUtil.DATE_TIME_FORMAT);
	}

	public static Date getPreDayStart(String hhmmss) {
		return DateUtil.parse(DateUtil.formatDateTime(getPrevDay(new Date()), DateUtil.DATE_FORMAT) + " " + hhmmss,
				DateUtil.DATE_TIME_FORMAT);
	}

	public static Date getNextDayStart(String hhmmss) {
		return DateUtil.parse(DateUtil.formatDateTime(getNextDay(new Date()), DateUtil.DATE_FORMAT) + " " + hhmmss,
				DateUtil.DATE_TIME_FORMAT);
	}

	public static Date getTodayEnd() {
		return DateUtil.parse(DateUtil.formatDateTime(new Date(), DateUtil.DATE_FORMAT) + " 23:59:59",
				DateUtil.DATE_TIME_FORMAT);
	}
}
